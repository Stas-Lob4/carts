...
Please visit the following link to reset your password:</p>
 <p style="color:#666;line-height: 1.6;"><a style="color: #007BFF;text-decoration: none;font-weight: bold;" href="https://carts-git-dev-stas-lob4.vercel.app/create-password/##token##">Reset Password</a></p>
<p style="color:#666;line-height: 1.6;">If you did not request a password reset, please ignore this message.</p>
<p style="color:#666;line-height: 1.6;">Thank you,</p>
<p style="color:#666;">Flash Cards Team.</p>
`
